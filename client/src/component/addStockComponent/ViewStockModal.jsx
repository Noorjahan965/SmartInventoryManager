...
const ViewStockModal = ({ selectedProduct, setSelectedProduct, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex justify-center items-center z-40">
      <div className="bg-white w-[90%] max-w-2xl rounded-lg shadow-lg p-5 space-y-4 animate-scaleIn border border-gray-200">
        ...
        <div className="pt-2 flex justify-end gap-4">
          ...
          <button
            onClick={() => handleAdd()}
            className="px-4 py-2 bg-blue-600 hover:bg-blue-800 rounded font-semibold text-white"
          >
            Add
          </button>
        </div>
